...
import cqupt.third.adapter.GridItemsAdapter;
import cqupt.third.bean.ItemBean;
import cqupt.third.utils.GameUtil;
import cqupt.third.utils.ImagesUtil;
...
public class PuzzleMain extends AppCompatActivity implements OnClickListener {
                ...
                if (mIsShowImg) {
                    ...
                    if (GameUtil.isMoveable(position)) {
                        ...
                        if (GameUtil.isSuccess()) {
                            ...
                            // 通知GridView更改UI
                            mAdapter.notifyDataSetChanged();
                            Toast.makeText(PuzzleMain.this, "Success!",
    ...
    private void handlerImage(Bitmap bitmap) {
        ...
        mPicSelected = new ImagesUtil().resizeBitmap(screenWidth * 0.9f, screenHeigt * 0.75f, bitmap);
    }
